<template>
  <div>
    ...
    >
      <div class="tab-layer">
        <div class="close-layer" @click="hideDialog()"></div>
              ...
              <div class="form">
                ...
                <div class="form-group textarea">
                  ...
                  <div class="group-right">
                    <textarea
                      class="form-control"
                      placeholder="请输入您的详细需求，如有问题请联系我们"
              ...
              <div class="form">
                  ...
                  <div class="group-right">
                    <div class="form-check">
                      <input
                        ...
                        name="open"
                        id="open"
                        v-model="questionForm.demandType"
                        value="1"
                      >
                      <label class="form-check-label btn" for="open">公开</label>
                    </div>
                    <div class="form-check">
                      <input
                        class="form-check-input"
                ...
                <div class="form-group textarea">
                  ...
                  <div class="group-right">
                    <textarea
                      class="form-control"
                      placeholder="请输入您的问题描述：，如有问题请联系我们"
